...
class Product_type extends PS_Controller
{
  ...
  public function add()
  {
    ...
    {
      if($this->product_type_model->is_exists($code))
      {
        $sc = FALSE;
  ...
  public function edit($code)
  {
    ...
    $this->load->view('masters/product_type/product_type_edit', $rs);
  }
  ...
  public function update()
  {
    ...
    if( ! empty($code) && ! empty($name))
    {
      if($this->product_type_model->is_exists($name, $code))
      {
        $sc = FALSE;
        set_error('exists', $name);
      }
      ...
      if($sc === TRUE)
      {
        if( ! $this->product_type_model->update($code, ['name' => trim($name)]))
        {
          $sc = FALSE;
          set_error('update');
        }
