...
class Product_brand extends PS_Controller
{
  ...
  public function add()
  {
    ...
    {
      if($this->product_brand_model->is_exists($code))
      {
        $sc = FALSE;
  ...
  public function edit($code)
  {
    ...
    $this->load->view('masters/product_brand/product_brand_edit', $rs);
  }
  ...
  public function update()
  {
    ...
    if( ! empty($code) && ! empty($name))
    {
      if($this->product_brand_model->is_exists($name, $code))
      {
        $sc = FALSE;
        set_error('exists', $name);
      }
      ...
      if($sc === TRUE)
      {
        if( ! $this->product_brand_model->update($code, ['name' => trim($name)]))
        {
          $sc = FALSE;
          set_error('update');
        }
