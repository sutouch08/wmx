...
class Wms_temp_tracking extends PS_Controller
{
	public $menu_code = 'WMSDOTK';
	public $menu_group_code = 'WMS';
  public $menu_sub_group_code = '';
	public $title = 'WMS Temp Delivery Tracking';
  public $filter;

  public function __construct()
  {
    parent::__construct();
    $this->home = base_url().'rest/V1/wms_temp_tracking';
  ...
  public function index()
  {
    $filter = array(
      ...
      'product_code' => get_filter('product_code', 'pd_code', ''),
		...
		$rows     = $this->wms_temp_tracking_model->count_rows($filter);
		//--- ส่งตัวแปรเข้าไป 4 ตัว base_url ,  total_row , perpage = 20, segment = 3
		$init	    = pagination_config($this->home.'/index/', $rows, $perpage, $segment);
		$list   = $this->wms_temp_tracking_model->get_list($filter, $perpage, $this->uri->segment($segment));
