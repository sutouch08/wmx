...
<div class="row">
	...
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding-5 text-right">
		...
		<?php if($this->pm->can_add) : ?>
			<button type="button" class="btn btn-white btn-success top-btn" onclick="add()"><i class="fa fa-save"></i>  Add</button>
		<?php endif; ?>
	</div>
</div><!-- End Row -->
<hr />
<div class="form-horizontal">
	<div class="form-group margin-top-30">
		...
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<input type="text" class="width-100 e" id="name" maxlength="100" value="" autofocus />
		</div>
								...
								<?php foreach($groups['menu'] as $menu) : ?>
									...
									<tr>
										...
										<td class="middle text-center">
											<label>
												<input type="checkbox" id="view-<?php echo $code; ?>" class="ace view-<?php echo $g_code.' '.$code; ?>" data-code="<?php echo $code; ?>" />
												<span class="lbl"></span>
											</label>
										</td>
										<td class="middle text-center">
											<label>
												<input type="checkbox" id="add-<?php echo $code; ?>"  class="ace add-<?php echo $g_code.' '.$code; ?>" data-code="<?php echo $code; ?>" />
												<span class="lbl"></span>
											</label>
										</td>
										<td class="middle text-center">
											<label>
												<input type="checkbox" id="edit-<?php echo $code; ?>" class="ace edit-<?php echo $g_code.' '.$code; ?>" data-code="<?php echo $code; ?>" />
												<span class="lbl"></span>
											</label>
										</td>
										<td class="middle text-center">
											<label>
												<input type="checkbox" id="delete-<?php echo $code; ?>" class="ace delete-<?php echo $g_code.' '.$code; ?>" data-code="<?php echo $code; ?>" />
												<span class="lbl"></span>
											</label>
										</td>
										<td class="middle text-center">
											<label>
												<input type="checkbox" id="approve-<?php echo $code; ?>" class="ace approve-<?php echo $g_code.' '.$code; ?>" data-code="<?php echo $code; ?>" />
												<span class="lbl"></span>
											</label>
										</td>
										<td class="middle text-center">
