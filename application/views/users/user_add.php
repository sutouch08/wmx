...
<div class="form-horizontal">
	<div class="form-group margin-top-30">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			...
			class="width-100 e" maxlength="50"
			onkeyup="validCode(this)" placeholder="Allow &nbsp; a-z,  A-Z,  0-9,  &quot;-&quot;,  &quot;_&quot;,  &quot;.&quot;,  &quot;@&quot;" autofocus />
		</div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="dname" id="dname" class="width-100 e"  />
    </div>
  ...
  <div class="form-group">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
			<button type="button" class="btn btn-white btn-success btn-100" onclick="add()">Save</button>
    </div>
  </div>
</div>
