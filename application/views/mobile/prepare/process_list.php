    ...
    <?php if( ! empty($data)) : ?>
      <?php foreach($data as $rs) : ?>
        ...
        <div class="list-block" onclick="goPrepare('<?php echo $rs->code; ?>')">
          <div class="list-link  <?php echo $backorder; ?>" >
            <div class="list-link-inner width-100">
              <div class="width-100">
                ...
                <span class="display-block font-size-11">ลูกค้า : <?php echo $rs->customer_name; ?></span>
                ...
                <span class="display-block font-size-11">
                  <span class="float-left width-30">จำนวน : <?php echo number($rs->qty); ?></span>
                  <span class="float-left width-70 text-right">พนักงาน : <?php echo empty($dName[$rs->update_user]) ? NULL : $dName[$rs->update_user]; ?></span>
                </span>
              </div>
            </div>
          </div>
	...
	<div class="pg-footer-inner">
      ...
      <div class="footer-menu">
				<span class="pg-icon" onclick="goTo('mobile/prepare')">
					<i class="fa fa-tasks fa-2x"></i><span>รอจัด</span>
				</span>
			</div>
      <div class="footer-menu">
				<span class="pg-icon" onclick="resetFilter('processList')">
