  ...
  <div class="pg-summary-inner">
    <div class="pg-summary-content">
      <div class="summary-text width-100">
        <span class="float-left font-size-16 width-50">ย้ายสินค้าออก</span>
          ...
          <div class="list-link" >
            <div class="list-link-inner width-100">
              <div class="no"><?php echo $no; ?></div>
                ...
                <span class="display-block font-size-11">From : <?php echo $rs->zone_name; ?></span>
							</div>
...
<script id="temp-row-template" type="text/x-handlebarsTemplate">
  <div class="list-block temp-row" id="temp-row-{{id}}" onclick="toggleTempChecked({{id}})">
    <input type="checkbox" class="temp-chk hide" id="temp-chk-{{id}}" data-id="{{id}}" value="{{id}}" />
    <div class="list-link">
      <div class="list-link-inner width-100">
        <div class="no"></div>
        <div class="padding-5">
          <span class="display-block font-size-11">{{product_code}}</span>
          <span class="display-block font-size-11">{{product_name}}</span>
          <span class="display-block font-size-11">From : {{zone_name}}</span>
        </div>
        <div class="text-center temp-qty-box">
          <span class="font-size-12">Qty</span>
          <input type="text" class="text-center text-label temp-qty" id="temp-qty-{{id}}" value="{{qty}}" readonly/>
        </div>
      </div>
    </div>
  </div>
