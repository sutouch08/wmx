          ...
          <div class="list-link" >
            <div class="list-link-inner width-100">
              ...
              <div class="width-100">
                ...
                <?php endif; ?>
                <?php if($rs->status == 'D') : ?>
                  <span class="display-block font-size-11">Canceled By : <?php echo $rs->cancle_user; ?></span>
                <?php elseif($rs->status == 'R' OR $rs->status == 'C') : ?>
                  <span class="display-block font-size-11">User : <?php echo $rs->update_user; ?></span>
                <?php else : ?>
                  <span class="display-block font-size-11">Owner : <?php echo $rs->user; ?></span>
                <?php endif; ?>
                <span class="display-block font-size-11">โซน :  <?php echo $rs->zone_code; ?></span>
              </div>
            </div>
          </div>
        </div>
