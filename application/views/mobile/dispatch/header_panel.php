<div class="filter-pad move-out" id="header-panel">
  ...
  <div class="page-wrap">
    ...
    <div class="col-xs-12 fi">
      ...
      <select class="form-control focus r e" id="sender" disabled>
    ...
    <div class="col-xs-12 fi">
  		...
  		<input type="text" class="form-control focus text-center r e" id="plate-no"  value="<?php echo $doc->plate_no; ?>" disabled/>
  	</div>

  	<div class="col-xs-12 fi">
  		<label>จังหวัด</label>
      <input type="text" class="form-control focus text-center r e" id="province" value="<?php echo $doc->plate_province; ?>" disabled/>
  	</div>

  	<div class="col-xs-12 fi">
  		<label>คนขับ</label>
  		<input type="text" class="form-control focus text-center r e" id="driver-name"  value="<?php echo $doc->driver_name; ?>" disabled/>
  	</div>
