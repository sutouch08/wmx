...
<?php   foreach($docs as $rs) : ?>
        <tr class="font-size-11" id="row-<?php echo $rs->code; ?>">
          <td class="middle">
            <button type="button" class="btn btn-minier btn-white btn-info" onclick="viewDetail('<?php echo $rs->code; ?>')"><i class="fa fa-eye"></i></button>
            <?php if($rs->status == 1) : ?>
            ...
            <?php if($rs->status == 0 && $this->pm->can_edit) : ?>
              <button type="button" class="btn btn-minier btn-white btn-warning" onclick="goEdit('<?php echo $rs->code; ?>')"><i class="fa fa-pencil"></i></button>
            <?php endif; ?>
            <?php if($rs->status == 0 && $this->pm->can_delete) : ?>
              <button type="button" class="btn btn-minier btn-white btn-danger" onclick="cancel('<?php echo $rs->code; ?>')"><i class="fa fa-times"></i></button>
            <?php endif; ?>
          </td>
