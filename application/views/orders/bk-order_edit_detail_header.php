<div class="row">
    ...
    <div class="col-lg-8 col-md-6-harf col-sm-6-harf col-xs-8 padding-5">
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 padding-5">
		...
		<div class="col-lg-1 col-md-1-harf col-sm-1-harf col-xs-4 padding-5">
		  ...
		  <select class="form-control input-sm" name="is_pre_order" id="is_pre_order" disabled>
		...
		<div class="col-lg-10-harf col-md-10-harf col-sm-10-harf col-xs-6 padding-5">
