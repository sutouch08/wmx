<div class="row">
	<div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-6 padding-5">
      ...
      <input type="text" class="form-control input-sm text-center" value="<?php echo $order->code; ?>" disabled />
		...
		<div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-6 padding-5">
			<label>Fulfill No.</label>
		  <input type="text" class="form-control input-sm text-center" value="<?php echo $order->fulfillment_code; ?>" disabled />
		</div>
    ...
    <div class="col-lg-5 col-md-5 col-sm-4-harf col-xs-12 padding-5">
    ...
    <div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-6 padding-5">
		...
		<div class="col-lg-1 col-md-1-harf col-sm-1-harf col-xs-6 padding-5">
			...
			<input type="text" class="width-100 text-center" value="<?php echo $order->is_backorder == 1 ? 'Yes' : 'No'; ?>" disabled />
		</div>
