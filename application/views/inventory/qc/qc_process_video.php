  ...
  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 ">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 margin-top-10">
        ...
        <a target="_blank" class="recorded-preview hide"></a>
      </div>
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 margin-top-10 hide">
        <p class="blue" style="margin-bottom:0px;">F1 = Start/Pause/Resume Record</p>
        <p class="blue" style="margin-bottom:0px;">F2 = Preview/Stop Camera</p>
        <p class="blue" style="margin-bottom:0px;">ESC = Stop Record and Save</p>
      </div>
    </div>
  </div>
