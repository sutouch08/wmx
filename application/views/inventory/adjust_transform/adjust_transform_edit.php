...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-5 text-right">
		...
		<?php if(($this->pm->can_add OR $this->pm->can_edit) && $doc->status == 0) : ?>
			<button type="button" class="btn btn-sm btn-success top-btn" onclick="saveAdjust()"><i class="fa fa-save"></i> บันทึก</button>
		<?php endif; ?>
	</div>
</div>
<hr class="padding-5" />
			...
			<table class="table table-striped border-1" style="min-width:910px;">
				<thead>
					<tr class="font-size-11">
						...
						<th class="fix-width-80 text-center">ในโซน</th>
						<th class="fix-width-100 text-center">ยอดตัด</th>
...
<script id="detail-template" type="text/x-handlebars-template">
	{{#each this}}
		...
		{{else}}
		<tr class="font-size-11 rox {{hilight}}" id="row-{{no}}">
