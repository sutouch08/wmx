...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-5 text-right">
		...
		<?php endif; ?>
		<button type="button" class="btn btn-white btn-info top-btn" onclick="printReceive()"><i class="fa fa-print"></i> พิมพ์</button>
  </div>
</div>
<hr />
<div class="row">
...
<script>
	...
	function updateShipDate() {
		...
		$.ajax({
			url:BASE_URL + 'inventory/receive_product/update_shipped_date',
			type:'POST',
			cache:false,
			data:{
				'code' : code,
...
<script src="<?php echo base_url(); ?>scripts/inventory/receive_product/receive_product.js?v=<?php echo date('YmdH');?>"></script>
<script src="<?php echo base_url(); ?>scripts/inventory/receive_product/receive_product_add.js?v=<?php echo date('YmdH');?>"></script>
