...
<div class="row">
	...
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding-5 text-right">
		...
		<?php endif; ?>
		<?php if($this->pm->can_delete && $doc->status != 'D') : ?>
		...
		<?php endif; ?>
		<?php if(($this->pm->can_edit && ($doc->status == 'O' OR $doc->status == 'C')) OR ($doc->status != 'P' && $this->_SuperAdmin)) : ?>
...
<div class="row">
  ...
  <div class="col-lg-5-harf col-md-7 col-sm-7 col-xs-6 padding-5">
  	<label>ชื่อโซน</label>
  ...
  <div class="col-lg-10-harf col-md-9 col-sm-8 col-xs-12 padding-5">
