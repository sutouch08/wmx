...
<div class="row">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding-5 text-right">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
          <li class="primary">
            <a href="javascript:add('P')">บันทึกเป็นดราฟท์</a>
          </li>
					<li class="success">
            <a href="javascript:add('C')">บันทึกรับเข้าทันที</a>
          </li>
					<li class="purple">
            <a href="javascript:add('O')">บันทึกรอรับ</a>
          </li>
        </ul>
      </div>
		<?php	endif; ?>
...
<div class="row">
  <div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-6 padding-5">
	...
	<div class="col-lg-2 col-md-3 col-sm-3-harf col-xs-6 padding-5">
		...
		<input type="text" class="form-control input-sm text-center h" name="invoice" id="invoice" value="" placeholder="อ้างอิงใบส่งสินค้า" />
	</div>
	...
	<div class="col-lg-3-harf col-md-4 col-sm-6 col-xs-6 padding-5">
		...
		<input type="text" class="form-control input-sm zone h" name="zoneName" id="zoneName" placeholder="ชื่อโซน" value="" />
	</div>
	...
	<?php if( ! empty($details)) : ?>
		<?php foreach($details as $rs) : ?>
			...
			<tr class="font-size-11" id="row-<?php echo $uid; ?>">
				...
				<td class="middle text-center">
					<input type="number"
						class="form-control input-sm text-center receive-qty r"
						id="receive-qty-<?php echo $uid; ?>"
						data-uid="<?php echo $uid; ?>"
						data-limit="<?php echo $rs->limit; ?>"
						data-backlogs="<?php echo $rs->backlogs; ?>"
						data-basecode="<?php echo $rs->po_code; ?>"
						data-baseline="<?php echo $rs->id; ?>"
						data-polinenum="<?php echo $rs->line_num; ?>"
