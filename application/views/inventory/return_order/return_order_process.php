...
<div class="row">
  <div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-4 padding-5">
	...
	<div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-4 padding-5">
		...
		<input type="text" class="form-control input-sm text-center edit" id="order-code" value="<?php echo $doc->order_code; ?>" disabled />
	</div>
	<div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-4 padding-5">
  ...
  <div class="col-lg-12 col-md-7 col-sm-7 col-xs-12 padding-5">
