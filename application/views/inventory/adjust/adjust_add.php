...
<div class="row">
	...
	<div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-4 padding-5">
		<label>วันที่</label>
		<input type="text" class="width-100 text-center e" id="date_add" value="<?php echo date('d-m-Y'); ?>" readonly />
	</div>
	<div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-4 padding-5">
		<label>Posting date</label>
		<input type="text" class="width-100 text-center e" id="post-date" value="" />
	</div>
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 padding-5">
		<label>อ้างอิง</label>
		<input type="text" class="width-100" id="reference" />
	</div>
