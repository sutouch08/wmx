...
<div class="row">
    ...
    <select class="width-100 filter" name="type" id="type">
			...
			<option value="ADD16" <?php echo is_selected('ADD16', $type); ?>>ADD16 | (Consignment Stock)</option>
			...
			<option value="ADD91" <?php echo is_selected('ADD91', $type); ?>>ADD91 | (Confirm Return Receipt)</option>
			...
			<option value="INT16" <?php echo is_selected('INT16', $type); ?>>INT16 | (Confirm Transfer In)</option>
			<option value="INT17" <?php echo is_selected('INT17', $type);?>>INT17 | (Adjust Stock)</option>
			<option value="INT17.1" <?php echo is_selected('INT17.1', $type);?>>INT17.1 | (Create Consignment Order)</option>
			<option value="INT20" <?php echo is_selected('INT20', $type); ?>>INT20 | (Orders)</option>
			<option value="INT21" <?php echo is_selected('INT21', $type); ?>>INT21 | (Confirm Order Fulfillment) </option>
			<option value="INT21.1" <?php echo is_selected('INT21.1', $type); ?>>INT21.1 | (Transfer In)</option>
			<option value="INT23" <?php echo is_selected('INT23', $type); ?>>INT23 | (Create Consign Order)</option>
		</select>
  </div>
