...
<div class="form-horizontal">
	<div class="form-group margin-top-30">
		...
		<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
			<input type="text" name="code" id="code" class="width-100 e" maxlength="15" value="" onkeyup="validCode(this)" autofocus />
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="name" id="name" class="width-100 e" maxlength="100" value="" />
		</div>
