...
<div class="form-horizontal">
    ...
    <div class="col-xs-12 col-sm-3">
      <input type="text" name="code" id="code" class="width-100 r" value="" />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-3">
			<input type="text" name="name" id="name" class="width-100 r" value="" />
    </div>
    ...
    <div class="col-xs-12 col-sm-3">
			<input type="number" name="position" id="position" class="width-50 r" value="" />
    </div>
