			...
			<?php if(!empty($data)) : ?>
				...
				<?php foreach($data as $rs) : ?>
					<tr class="font-size-11" id="row-<?php echo $no; ?>">
						...
						<td class="middle text-center"><?php echo number($this->product_sport_type_model->count_members($rs->code)); ?></td>
					</tr>
					<?php $no++; ?>
				<?php endforeach; ?>
			<?php endif; ?>
...
<script src="<?php echo base_url(); ?>scripts/masters/product_sport_type.js?v=<?php echo date('Ymd'); ?>"></script>
