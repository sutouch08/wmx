...
<div class="form-horizontal">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
      <input type="text" class="width-100 e" id="code" value="<?php echo $wh->code; ?>" disabled/>
		</div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			  <input type="text" class="width-100 e" id="name" maxlength="100" value="<?php echo $wh->name; ?>"/>
    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
			<label style="margin-top:7px; padding-left:10px;">
				<input type="checkbox" class="ace" id="auz" value="1" <?php echo is_checked($wh->auz, '1'); ?>/>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
			<label style="margin-top:7px; padding-left:10px;">
				<input type="checkbox" class="ace" id="freeze" value="1" <?php echo is_checked($wh->freeze, '1'); ?>/>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
			<label style="margin-top:7px; padding-left:10px;">
				<input type="checkbox" class="ace" id="active" value="1" <?php echo is_checked($wh->active, '1'); ?>/>
