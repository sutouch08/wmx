...
<div class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-4">
			<input type="text" id="name" class="width-100 e" maxlength="150" value="<?php echo $name; ?>" placeholder="Required" />
    </div>
    ...
    <div class="col-xs-12 col-sm-1">
			<input type="number" id="credit_term" class="width-100" value="<?php echo get_zero($credit_term); ?>" />
    </div>
    ...
    <div class="col-xs-12 col-sm-2">
			<input type="text" id="tax_id" class="width-100" maxlength="20" value="<?php echo $tax_id; ?>" />
    </div>
    ...
    <div class="col-xs-12 col-sm-2">
			<input type="text" id="branch_code" class="width-100" maxlength="20" value="<?php echo $branch_code; ?>" />
    </div>
    ...
    <div class="col-xs-12 col-sm-2">
			<input type="text" id="branch_name" class="width-100" maxlength="50" value="<?php echo $branch_name; ?>" />
    </div>
	...
	<?php $active = $status == 1 ? 'btn-success' : ''; ?>
	<?php $inactive = $status == 0 ? 'btn-danger' : ''; ?>
	<div class="form-group">
    ...
    <div class="col-xs-12 col-sm-3">
			<div class="btn-group input-medium">
				<button type="button" class="btn btn-sm width-50 <?php echo $active; ?>" id="active-on" onclick="toggleActive(1)">ใช้งาน</button>
				<button type="button" class="btn btn-sm width-50 <?php echo $inactive; ?>" id="active-off" onclick="toggleActive(0)">ไม่ใช้งาน</button>
				<input type="hidden" id="active" name="active" value="<?php echo $status; ?>">
			</div>
    </div>
  </div>
