...
<div class="form-horizontal">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <input type="text" name="code" id="code" class="width-100 e" maxlength="20" value="<?php echo $code; ?>" onkeyup="validCode(this)" disabled  />
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<input type="text" name="name" id="name" class="width-100 e" maxlength="150" value="<?php echo $name; ?>"  />
    </div>
    <div class="help-block col-xs-12 col-sm-reset inline red" id="name-error"></div>
  </div>

	<?php
		$ac = $active == '1' ? 'btn-success' : '';
		$iac = $active == '0' ? 'btn-danger' : '';
	?>
	<div class="form-group">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<div class="btn-group input-medium">
				...
				<button type="button" class="btn btn-sm <?php echo $iac; ?> width-50" id="active-off" onclick="toggleActive(0)">Inactive</button>
