...
<div class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" class="width-100" value="<?php echo $item->code; ?>" readonly />
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="name" id="name" maxlength="150" class="width-100 e" value="<?php echo $item->name; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="barcode" id="barcode"  maxlength="100" class="width-100 e" value="<?php echo $item->barcode; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="style" id="model" maxlength="50" class="width-100 e" value="<?php echo $item->model_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="color" id="color" maxlength="20" class="width-100 e" value="<?php echo $item->color_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="size" id="size" maxlength="20" class="width-100 e" value="<?php echo $item->size_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" class="width-100 e" value="<?php echo number($item->cost, 2); ?>"  readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" class="width-100 e" value="<?php echo number($item->price, 2); ?>"  readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="unit" id="unit" maxlength="10" class="width-100 e" value="<?php echo $item->unit_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="brand" id="brand" maxlength="20" class="width-100 e" value="<?php echo $item->brand_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="main_group" id="main-group" maxlength="20" class="width-100 e" value="<?php echo $item->main_group_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="group" id="group" maxlength="20" class="width-100 e" value="<?php echo $item->group_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="category" id="category" maxlength="20" class="width-100 e" value="<?php echo $item->category_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="kind" id="kind" maxlength="20" class="width-100 e" value="<?php echo $item->kind_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="type" id="type" maxlength="20" class="width-100 e" value="<?php echo $item->type_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="collection" id="collection" maxlength="20" class="width-100 e" value="<?php echo $item->collection_code; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="number" name="year" id="year" maxlength="4" class="width-100 e" value="<?php echo $item->year; ?>" readonly/>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<label style="padding-top:5px;">
				<input name="count_stock" class="ace" type="checkbox" id="count-stock" value="1" <?php echo is_checked($item->count_stock,1); ?> disabled/>
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<label style="padding-top:5px;">
				<input name="active" class="ace" type="checkbox" id="active" value="1" <?php echo is_checked($item->active,1); ?> disabled/>
